...
Почему `adb reverse`, а не `10.0.2.2`: с reverse-пробросом в эмуляторе можно открыть именно `127.0.0.1`, а это secure context. Так Service Worker и PWA в целом работают корректнее.
